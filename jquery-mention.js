...
jQuery(document).ready(function($){
    ...
    var calculator = {
        ...
        getCaretPosition: function() {
            ...
            if (McaBrowserDetect.browser == 'MSIE' && McaBrowserDetect.version <= 9) {
            ...
            return {
                top: focusOffset.top - simulatorOffset.top - element.scrollTop
                    ...
                    + (McaBrowserDetect.browser == 'Firefox' ? 0 : parseInt(self.getComputedStyle("fontSize"))),
    ...
    $.fn.extend({
        ...
        getComputedStyle: function(styleName) {
            ...
            result = result || (McaBrowserDetect.browser == 'MSIE' ?
